...
func TestMail(t *testing.T) {
	config := `{"username":"mikeqian@gmail.com","password":"mikeqian","host":"smtp.gmail.com","port":587}`
	mail := NewEMail(config)
	if mail.Username != "mikeqian@gmail.com" {
		t.Fatal("email parse get username error")
	}
	if mail.Password != "mikeqian" {
